...
int main()
{
    ...
    std::cout << "This is a nice message ...." << std::endl
              << std::flush;
    // After this std::flush, we're sure that at this line, the message has been sent to the stream. this may be important in some applications.
    ...
    std::cout << std::setw(10) << "Lastname" << std::setw(10) << "Firstname" << std::setw(5) << " 25 " << std::endl;
    ...
    std::cout << std::setw(col_width) << "Lastname" << std::setw(col_width) << "Firstname" << std::setw(col_width) << " 25 " << std::endl;
    ...
    // boolalpha and no boolalpha : control bool output format : true/false and 1/0
    ...
    // !Note : These only work with integers
    ...
    // setprecision() : the number of digits printed out for a floatig point. Default precision is 6 
    ...
    // If the precision is bigger than supported by the type, you'll just print garbage values or digits after the precision limit 
