...
int main()
{
    ...
    // floor
    std::cout << "Weight rounted to floor is : " << std::floor(weight) << std::endl;
    ...
    // log : reverse function of pow. If 2^3 = 8, log 8 in base 2 = 3. Log is like asking to which exponent should we elevate 2 to get eight ? Log, by default computes to log in base 3. There also is another function which uses base 10 called log10
    ...
    // log10, 10 ^ 4 = 10000, to get 10k, you'd need to elevate 10 to power of ?
