...
{ // Function parameters
    ...
    {
        std::cout << "Sorry, you're too yound for this . No offense! " << std::endl;
    }
    return; // you may or may not do this for void functionsddd
}
...
// Function that takes no parametes and return something
int lucky_number()
{
    return 99;
}
...
int main()
{
    ...
    double incr_mul_result = increment_multiply(h,i);
