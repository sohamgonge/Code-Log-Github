...
int main()
{
    ...
    // Pointes to different variable are of the same size
    ...
    // It doesn't matter if you put the * close to data tyep or to variable name
    ...
    // Confusing as youo wonder if other_int_var6 is also
    //  a pointer to int. It is not the structure is exactly the same
    ...
    // Wek know that pointers store addrresses of varaibles
    int int_var {43};
    ...
    // Can't cross assign between pointer of diffrent types
    int *p_int1{nullptr};
