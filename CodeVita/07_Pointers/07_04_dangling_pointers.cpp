...
int main()
{
    ...
    */
    ...
    std::cout << "Program completed safely" << std::endl;
    */
    ...
    std::cout << "p_number 3 - " << p_number3 << " - " << *p_number3 << std::endl;
    std::cout << "p_number 4 - " << p_number4 << " - " << *p_number4 << std::endl;
    ...
    */
    ...
    // std::cout << "*p_number6 : " << *p_number6 << std::endl; // Will crash the program
    ...
    */
    ...
    if(!(p_number8 == nullptr)){ // Only use the slave pointers when master pointer is valid 
        std::cout << "p_number9 - " << p_number9  << " - " << *p_number9 << std::endl;
    }
    else {
