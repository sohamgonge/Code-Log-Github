...
int main()
{
    ...
    // If you store raw object data in an array set up to store base class objects the data is going to be sliced off!
    /*
    ...
    // Compiler error because we cann't have an array of references becase the rules for an datatype array is that it should be left unassigned and whose data can be changed or reassigned
