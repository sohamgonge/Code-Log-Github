...
int main()
{
    ...
    std::string message{"Hello there", 5};              // Initialize with par tof stirng literal.
    // contains this Hello
    ...
    // starting at index 6, taking 5 characters. Will contain World.
    ...
    planet = "Earth. Where the sky is blue Earth. Where the sky is blueEarth. Where the sky is blue";
    std::cout << "planet : " << planet << std::endl;

    // Use a raw array
    const char *planet1{"Earth. Where the sky is blue"};
    planet1 = "Earth. Where the sky is blueEarth. Where the sky is blueEarth. Where the sky is blue";
 
    /*
    With planet1, the old text still exists in memory even though I no longer need it.
    With planet (std::string), the old text is replaced by the new one in memory.
    */
    std::cout << "planet : " << planet << std::endl;
